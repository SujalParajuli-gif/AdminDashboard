                        ...
                        <h3 class="ndhead" style="cursor: default;">Step into your private space with confidence and elegance <br>
                            ...
                            <div class="placeholderss" >
                                <form action="" >
                                    ...
                                    <input type="text" name="Username" placeholder="Username" required class="plcholder" ><br><img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
                                    <input type="datetime" name="Username" placeholder="Date of Birth" required class="plcholder" ><br>
                                    <img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
                                    <input type="text" name="Username" placeholder="Gender" required class="plcholder" ><br>
                                    <img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
                                    <input type="Email" name="Username" placeholder="Email" required class="plcholder" ><br>
                                    <img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
                                    <input type="password" name="Username" placeholder="Password" required class="plcholder" ><br>
                                    <img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
                                    <input type="number" name="Username" placeholder="Phone Number" required class="plcholder" ><br>
                                    <img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
