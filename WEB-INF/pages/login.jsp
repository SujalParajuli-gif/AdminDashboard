                    ...
                    <div class="Text11" style="z-index: 1;">
                        ...
                        <h3 class="ndhead" style="cursor: default;">Step into your private space with confidence and elegance <br>
                            ...
                            <div class="placeholderss" >
                                <form action="" >
                                    <input type="text" name="Username" placeholder="Username or Email" required class="plcholder" ><br>
                                    <img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
                                    <input type="email" name="Password" placeholder="Password" required class="plcholder" ><br><img src="${pageContext.request.contextPath}/assets/img/Longvect.png" alt=""><br>
