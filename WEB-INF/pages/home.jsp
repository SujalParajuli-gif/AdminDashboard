...
<body>
    <div id="main">
        ...
        <nav class="main-nav" style="top: 15px;">
            <div class="menuebar" style="position: relative; left: 60px; cursor: pointer;"><a class="Menu">Menu</a>
        ...
        <div class="Insidemenu">
            ...
            <div class="Bookholder2">
                ...
                <a href="#" class="pptt2">Legals</a>
                <a href="#" class="pptt2">Site-map</a>
                <a href="#" class="pptt2">Credits</a>
                <div class="social-icons">
                    <a href="https://www.facebook.com/login.php/" target="_blank"><img src="${pageContext.request.contextPath}/assets/PNG/Facebook icon.png" alt="Facebook" /></a>
                    <a href="https://x.com/i/flow/login" target="_blank"><img src="${pageContext.request.contextPath}/assets/PNG/twitter icon.png" alt="Twitter" /></a>
                    <a href="https://www.youtube.com/" target="_blank"><img src="${pageContext.request.contextPath}/assets/PNG/Youtube icon.png" alt="YouTube" /></a>
                    <a href="https://github.com/" target="_blank"><img src="${pageContext.request.contextPath}/assets/PNG/githubicon.png" alt="GitHub" /></a>
                </div>
            </div>
        </div>
