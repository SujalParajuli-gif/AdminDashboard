...
<body>
    <header>
         ...
         <nav class="main-nav" style="top: 15px;">
            ...
            <div class="logo" style="position: relative; left: 210px;"><a href="home"><img src="${pageContext.request.contextPath}/assets/PNG/black logo.png" alt="Logo" /></div></a>
            <div class="inner-main-nav">
                <ul>
                    <li id="coll"><a href="#">Collections</a></li>
                    <li id="coll"><a href="contact.jsp">Contact</a></li>
        ...
        <div>
            <img src="${pageContext.request.contextPath}/assets/PNG/Vector 9.png" style=" padding-left: 955px;  position: relative; top: -250px;" class="sepration">
        </div>      
        </div>
